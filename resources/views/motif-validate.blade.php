        ...
        <div class="card-body">
            ...
            <div class="flex flex-col justify-center items-center">
                <div class="w-full max-w-xxl">
                    <a href="{{ url('/motifs') }}"
                        class="bg-blue-900 hover:bg-blue-300 text-white font-bold py-2 px-4 rounded-full my-2">Historique
                        des Motifs Validé</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('motifs.edit', $motifs->id) }}"
                                        class="btn btn-primary btn-sm">Edit</a>
                                    <form action="{{ route('motifs.validat', $motifs->id) }}" method="post"
